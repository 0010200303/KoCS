...
def write_typst_table(avg_by_benchmark, out_path: Path):
    ...
    benchmark_order = ["ControlKernel", "SplitKernel", "UserFusedKernel", "AutoFusedKernel"]
...
def main():
    ...
    color_by_benchmark = {
        "ControlKernel": _solstice[0],
        "SplitKernel": _solstice[1],
        "UserFusedKernel": _solstice[2],
        "AutoFusedKernel": _solstice[3],
    }
