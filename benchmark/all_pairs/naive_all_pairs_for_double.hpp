#ifndef KOCS_BENCHMARK_NAIVE_ALL_PAIRS_FOR_DOUBLE_HPP
#define KOCS_BENCHMARK_NAIVE_ALL_PAIRS_FOR_DOUBLE_HPP
...
namespace kocs::benchmark {
  ...
  struct NaiveAllPairsForDouble {
    using positions_view_type = PositionsView;

    struct Settings { };

    NaiveAllPairsForDouble(
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag("all_pairs_double_total_drag", agent_count);
      Kokkos::View<typename PositionsView::value_type*>
        total_velocity("all_pairs_double_total_velocity", agent_count);

      Kokkos::parallel_for(
        "naive_all_pairs_for_double_apply_force",
      ...
      Kokkos::parallel_for(
        "naive_all_pairs_for_double_apply_drag_j",
        agent_count,
...
#endif // KOCS_BENCHMARK_NAIVE_ALL_PAIRS_FOR_DOUBLE_HPP
