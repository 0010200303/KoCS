#ifndef KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_FOR_HPP
#define KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_FOR_HPP
...
namespace kocs::benchmark {
  ...
  struct BinnedAllPairsReduceFor {
...
#endif // KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_FOR_HPP
