...
style_for_benchmark = {
    ...
    "BinnedReduceFor":                      {"linestyle": "-",  "color": _BINNED_COLORS[0], "alpha": 0.7, "linewidth": 1.5},
    "BinnedReduceForDouble":                {"linestyle": "--", "color": _BINNED_COLORS[1], "alpha": 0.8, "linewidth": 2.0},
    "BinnedReduceForSymmetric":             {"linestyle": ":",  "color": _BINNED_COLORS[2], "alpha": 0.9, "linewidth": 2.5},
    "BinnedReduceParallel":                 {"linestyle": "-",  "color": _BINNED_COLORS[3], "alpha": 0.7, "linewidth": 1.5},
    "BinnedReduceParallelDouble":           {"linestyle": "--", "color": _BINNED_COLORS[4], "alpha": 0.8, "linewidth": 2.0},
    "BinnedReduceParallelSymmetric":        {"linestyle": ":",  "color": _BINNED_COLORS[5], "alpha": 0.9, "linewidth": 2.5},
}
