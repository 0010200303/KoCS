#ifndef KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_PARALLEL_SYMMETRIC_HPP
#define KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_PARALLEL_SYMMETRIC_HPP
...
namespace kocs::benchmark {
  ...
  struct BinnedAllPairsReduceParallelSymmetric {
    ...
    BinnedAllPairsReduceParallelSymmetric(
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag("baps_total_drag", agent_count);
      Kokkos::View<typename PositionsView::value_type*>
        total_velocity("baps_total_velocity", agent_count);

      Kokkos::parallel_for(
        "binned_all_pairs_rp_sym_apply_force",
      ...
      Kokkos::parallel_for(
        "binned_all_pairs_rp_sym_apply_drag",
        agent_count,
...
#endif // KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_PARALLEL_SYMMETRIC_HPP
