#ifndef KOCS_BENCHMARK_NAIVE_ALL_PAIRS_PARALLEL_REDUCE_HPP
#define KOCS_BENCHMARK_NAIVE_ALL_PAIRS_PARALLEL_REDUCE_HPP
...
namespace kocs::benchmark {
  ...
  struct NaiveAllPairsParallelReduce {
    using positions_view_type = PositionsView;

    struct Settings { };

    NaiveAllPairsParallelReduce(
...
#endif // KOCS_BENCHMARK_NAIVE_ALL_PAIRS_PARALLEL_REDUCE_HPP
