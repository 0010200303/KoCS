#ifndef KOCS_BENCHMARK_NAIVE_ALL_PAIRS_SPREAD_HPP
#define KOCS_BENCHMARK_NAIVE_ALL_PAIRS_SPREAD_HPP
...
namespace kocs::benchmark {
  ...
  struct NaiveAllPairsSpread {
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag_view("naive_all_pairs_apply_force_total_drag", agent_count);
      Kokkos::View<Vector*> total_velocity_view("naive_all_pairs_apply_force_total_velocity", agent_count);
...
#endif // KOCS_BENCHMARK_NAIVE_ALL_PAIRS_SPREAD_HPP
