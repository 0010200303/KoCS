#ifndef KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_PARALLEL_HPP
#define KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_PARALLEL_HPP
...
namespace kocs::benchmark {
  ...
  struct BinnedAllPairsReduceParallel {
...
#endif // KOCS_BENCHMARK_BINNED_ALL_PAIRS_REDUCE_PARALLEL_HPP
