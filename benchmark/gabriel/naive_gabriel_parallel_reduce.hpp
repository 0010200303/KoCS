#ifndef KOCS_BENCHMARK_NAIVE_GABRIEL_PARALLEL_REDUCE_HPP
#define KOCS_BENCHMARK_NAIVE_GABRIEL_PARALLEL_REDUCE_HPP
...
namespace kocs::benchmark {
  ...
  struct NaiveGabrielParallelReduce {
...
#endif // KOCS_BENCHMARK_NAIVE_GABRIEL_PARALLEL_REDUCE_HPP
