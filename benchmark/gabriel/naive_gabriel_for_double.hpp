#ifndef KOCS_BENCHMARK_NAIVE_GABRIEL_FOR_DOUBLE_HPP
#define KOCS_BENCHMARK_NAIVE_GABRIEL_FOR_DOUBLE_HPP
...
namespace kocs::benchmark {
  ...
  struct NaiveGabrielForDouble {
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag("gabriel_double_total_drag", agent_count);
      Kokkos::View<typename PositionsView::value_type*>
        total_velocity("gabriel_double_total_velocity", agent_count);

      Kokkos::parallel_for(
        "naive_gabriel_for_double_apply_force",
      ...
      Kokkos::parallel_for(
        "naive_gabriel_for_double_apply_drag_j",
        agent_count,
...
#endif // KOCS_BENCHMARK_NAIVE_GABRIEL_FOR_DOUBLE_HPP
