#ifndef KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_SYMMETRIC_HPP
#define KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_SYMMETRIC_HPP
...
namespace kocs::benchmark {
  ...
  struct BinnedGabrielReduceForSymmetric {
    ...
    BinnedGabrielReduceForSymmetric(
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag("bfs_total_drag", agent_count);
      Kokkos::View<typename PositionsView::value_type*>
        total_velocity("bfs_total_velocity", agent_count);

      Kokkos::parallel_for(
        "binned_gabriel_rf_sym_apply_force",
      ...
      Kokkos::parallel_for(
        "binned_gabriel_rf_sym_apply_drag",
        agent_count,
...
#endif // KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_SYMMETRIC_HPP
