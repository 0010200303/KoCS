#ifndef KOCS_BENCHMARK_NAIVE_GABRIEL_PARALLEL_REDUCE_SYMMETRIC_HPP
#define KOCS_BENCHMARK_NAIVE_GABRIEL_PARALLEL_REDUCE_SYMMETRIC_HPP
...
namespace kocs::benchmark {
  ...
  struct NaiveGabrielParallelReduceSymmetric {
    ...
    NaiveGabrielParallelReduceSymmetric(
    ...
    void evaluate_force(
      ...
      Kokkos::parallel_for(
        "naive_gabriel_pr_sym_apply_force",
      ...
      Kokkos::parallel_for(
        "naive_gabriel_pr_sym_apply_drag",
        agent_count,
...
#endif // KOCS_BENCHMARK_NAIVE_GABRIEL_PARALLEL_REDUCE_SYMMETRIC_HPP
