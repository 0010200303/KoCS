#ifndef KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_DOUBLE_HPP
#define KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_DOUBLE_HPP
...
namespace kocs::benchmark {
  ...
  struct BinnedGabrielReduceForDouble {
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag("bfd_total_drag", agent_count);
      Kokkos::View<typename PositionsView::value_type*>
        total_velocity("bfd_total_velocity", agent_count);

      Kokkos::parallel_for(
        "binned_gabriel_rf_double_apply_force",
      ...
      Kokkos::parallel_for(
        "binned_gabriel_rf_double_apply_drag_j",
        agent_count,
...
#endif // KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_DOUBLE_HPP
