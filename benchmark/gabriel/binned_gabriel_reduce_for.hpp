#ifndef KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_HPP
#define KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_HPP
...
#endif // KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_FOR_HPP
