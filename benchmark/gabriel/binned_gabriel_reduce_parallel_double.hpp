#ifndef KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_PARALLEL_DOUBLE_HPP
#define KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_PARALLEL_DOUBLE_HPP
...
namespace kocs::benchmark {
  ...
  struct BinnedGabrielReduceParallelDouble {
    ...
    BinnedGabrielReduceParallelDouble(
    ...
    void evaluate_force(
      ...
      Kokkos::View<Scalar*> total_drag("bpd_total_drag", agent_count);
      Kokkos::View<typename PositionsView::value_type*>
        total_velocity("bpd_total_velocity", agent_count);

      Kokkos::parallel_for(
        "binned_gabriel_rp_double_apply_force",
      ...
      Kokkos::parallel_for(
        "binned_gabriel_rp_double_apply_drag_j",
        agent_count,
...
#endif // KOCS_BENCHMARK_BINNED_GABRIEL_REDUCE_PARALLEL_DOUBLE_HPP
