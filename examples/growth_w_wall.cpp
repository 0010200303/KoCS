...
int main() {
  ...
  pair_finder_settings.min_bounds = Vector(-50);
  pair_finder_settings.max_bounds = Vector(50);

  Simulation<SimulationConfig> sim(n_max, "./output/growth_w_wall", r_max, pair_finder_settings);
